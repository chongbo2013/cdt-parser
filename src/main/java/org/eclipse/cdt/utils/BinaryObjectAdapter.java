...
public abstract class BinaryObjectAdapter extends BinaryFile implements IBinaryObject {
	...
	/**
	 * @see IBinaryObject#isLittleEndian()
	 */
	@Override
	public boolean isLittleEndian() {
		BinaryObjectInfo info = getBinaryObjectInfo();
	...
	/**
	 * @see IBinaryParser.IBinaryExecutable#getNeededSharedLibs()
	 */
	...
	/**
	 * @see IBinaryParser.IBinaryShared#getSoName()
	 */
