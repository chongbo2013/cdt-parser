...
public class Elf implements AutoCloseable {
	...
	public Attribute getAttributes() throws IOException {
		...
		case ELFhdr.EM_68K:
			...
			break;
		case ELFhdr.EM_PPC:
		case ELFhdr.EM_CYGNUS_POWERPC:
		case ELFhdr.EM_RS6000:
			attrib.cpu = "ppc"; //$NON-NLS-1$
			break;
		case ELFhdr.EM_PPC64:
		...
		case ELFhdr.EM_ARM:
			...
			break;
		case ELFhdr.EM_AARCH64:
			attrib.cpu = "aarch64"; //$NON-NLS-1$
			break;
		case ELFhdr.EM_MIPS_RS3_LE:
		case ELFhdr.EM_MIPS:
			attrib.cpu = "mips"; //$NON-NLS-1$
			break;
		case ELFhdr.EM_SPARC32PLUS:
		case ELFhdr.EM_SPARC:
		case ELFhdr.EM_SPARCV9:
			attrib.cpu = "sparc"; //$NON-NLS-1$
			break;
		case ELFhdr.EM_H8_300:
		case ELFhdr.EM_H8_300H:
			attrib.cpu = "h8300"; //$NON-NLS-1$
			break;
		case ELFhdr.EM_V850:
		case ELFhdr.EM_CYGNUS_V850:
			attrib.cpu = "v850"; //$NON-NLS-1$
			break;
		case ELFhdr.EM_MN10300:
		case ELFhdr.EM_CYGNUS_MN10300:
			attrib.cpu = "mn10300"; //$NON-NLS-1$
			break;
		case ELFhdr.EM_MN10200:
		case ELFhdr.EM_CYGNUS_MN10200:
		...
		switch (ehdr.e_ident[ELFhdr.EI_DATA]) {
		case ELFhdr.ELFDATA2LSB:
			attrib.isle = true;
			break;
		case ELFhdr.ELFDATA2MSB:
			attrib.isle = false;
			break;
		}
		switch (ehdr.e_ident[ELFhdr.EI_CLASS]) {
